...
if __name__ == "__main__":
    ...
    original_data_path = os.path.join(current_dir, '..', 'data', 'raw', 'fix_data.csv')
    model_path = os.path.join(current_dir, '..', 'models', 'svm_model7030.pkl')
    report_dir = os.path.join(current_dir, '..', 'data', 'report')
    txt_report_path = os.path.join(report_dir, "classification_report_7030.txt")
    json_report_path = os.path.join(report_dir, "classification_report_7030.json")
    top_features_path = os.path.join(report_dir, "top_features_7030.txt")
    confmet_path = os.path.join(report_dir, "confusion_matrix_7030.png")
